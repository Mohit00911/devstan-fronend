  ...
  const tabs = [
    {
      label: "Content",
      labelNo: 1,
      content: <ContentTabContent onDataFromChild={handleDataFromChild}  onSaveChanges={handleSaveChanges}/>,
    },
    {
      label: "Details",
      labelNo: 2,
      content: <LocationTabContent onDataFromChild={handleDataFromChild} onSaveChanges={handleSaveChanges}/>,
    },
    {
      label: "Important Information",
      labelNo: 3,
      content: <PricingTabContent onDataFromChild={handleDataFromChild} onSaveChanges={handleSaveChanges}/>,
    },
    {
      label: "itinery",
      labelNo: 4,
